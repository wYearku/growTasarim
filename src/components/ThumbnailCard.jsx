...
const ThumbnailCard = ({ image, title, content, price, oldPrice, url }) => {
  return (
    <div className="flex flex-col relative group !h-[530px] text-black rounded-xl overflow-hidden">
      <Link href={`/${url}`}>
        <Image
          width={100000}
          height={100000}
          src={image}
          className="!w-full !h-[530px] object-cover group-hover:scale-110 transition-all duration-300 ease-in-out"
        />
